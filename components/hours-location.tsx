    ...
    <section className="mx-auto max-w-6xl px-6 py-20">
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-border bg-card p-8">
          ...
          <h2 className="mt-2 font-serif text-3xl text-foreground">Find our demo space</h2>
          ...
          <p className="mt-4 text-sm text-muted">
            This address is a placeholder for demonstration only.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              ...
              className="rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-foreground/90"
            >
              Get Directions
            </a>
            <Link
